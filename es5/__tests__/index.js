...
describe('Nexus Flux', function test() {
  ...
  it('should not throw', function (done) {
    ...
    _lodash2.default.defer(function () {
      ...
      var actions = {
        '/addItem': function addItem(_ref) {
          ...
          var item = { name: name, description: description, ownerHash: (0, _sha2.default)(ownerKey) };
        ...
        '/removeItem': function removeItem(_ref2) {
          ...
          if ((0, _sha2.default)(ownerKey) !== ownerHash) {
            return;
          }
    ...
    // client main
    _lodash2.default.defer(function () {
      var ownerKey = (0, _sha2.default)(Date.now() + ':' + _lodash2.default.random());
      ...
      .setTimeout(function () {
        client.dispatchAction('/addItem', { name: 'Faster', description: 'Code Faster', ownerKey: ownerKey });
      }, 1000)
      // remove an item in 2000ms
      .setTimeout(function () {
        client.dispatchAction('/removeItem', { name: 'Harder', ownerKey: ownerKey });
      }, 2000)
